           ...
           <div class="row">
             <div class="col">
                <div class="form-group">
                    <label>Message:</label>
                    <textarea type="text" class="form-control form-control-sm" name="title" placeholder="Enter Slider Title"
